...
function ProgressSteps({ currentStep }: { currentStep: number }) {
  ...
  return (
    <div className="bg-gradient-to-r from-[#f5f0e8] to-[#ebe3d7] p-5" data-testid="progress-steps">
            ...
            {index < steps.length - 1 && (
              <div
                className={`w-10 h-1 mx-1 rounded-full transition-all duration-300 ${
                  step.number < currentStep ? "bg-gradient-to-r from-primary to-[#d4a574]" : "bg-muted"
                }`}
              />
            )}
          </div>
