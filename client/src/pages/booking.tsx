              ...
              {index < arr.length - 1 && (
                <div
                  className={`w-10 h-1 mx-1 rounded-full ${
                    step.number < 2 ? "bg-gradient-to-r from-[#d4a574] to-[#c4956a]" : "bg-white/20"
                  }`}
                />
              )}
            </div>
  ...
  return (
    <section className="px-4 py-8" data-testid="section-booking-form">
      <div className="max-w-md mx-auto bg-white rounded-2xl shadow-xl p-6 space-y-6 animate-fade-in">
        ...
        <div className="bg-gradient-to-r from-[#f5f0e8] to-[#ebe3d7] rounded-xl p-5">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="font-bold text-xl text-primary">40 ر.س</span>
          </div>
        </div>
